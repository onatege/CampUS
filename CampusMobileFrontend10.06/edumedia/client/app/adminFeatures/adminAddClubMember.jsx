...
import AdminUserSearchItem from "../../components/listItems/adminUserSearchItem";
...
const renderItem = ({ item, index , clubId}) => {
    return (
        < >
            {item ?
                <AdminUserSearchItem key={index} item={item} clubId={clubId} />
                :
...
export default AdminAddClubMember