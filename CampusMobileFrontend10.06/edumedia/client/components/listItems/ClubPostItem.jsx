...
function ClubPostItem({ item, isMember, clubId }) {
    ...
    const handleRedirectProfile = (id, e) => {
        e.preventDefault();
        router.push({ pathname: "features/clubDetails", params: { clubId: clubId } });
    };

    const handleRedirectClubPostDetail = () => {
        router.push({ pathname: "features/clubPostDetails", params: { clubPostId: item?.clubPostId, isMember: isMember, clubId: clubId } })
    }
