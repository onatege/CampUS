...
export default function TakePhotoService({ setImageName, placeHolder, isLoading, setIsLoading }) {
        ...
        <>
            {
                isLoading ?
                    ...
                    :
                    <TouchableOpacity onPress={takePhoto} style={{ height: 50, width: 50, borderWidth: 0.4, borderColor: 'gray', borderRadius: 10, marginRight: 5, justifyContent: 'center', alignItems: 'center', backgroundColor: 'transparent' }}>
                        <Image placeholder={require('../assets/icons/camera.svg')} contentFit='contain' style={{ width: '50%', height: '50%', borderRadius: 10, padding: 15 }} />
                    </TouchableOpacity>
            }
        </>
